...
export const englishLexicon = {
  ...
  inbox: "Inbox",
  outbox: "Outbox",
  noMessagesPlaceHolder: "No Messages",
  messageColumnHeaderText: "Message",
  toColumnHeaderText: "To",
  fromColumnHeaderText: "From",
  sentColumnHeaderText: "Sent",
  recievedColumnHeaderText: "Recieved",
  deleteButtonText: "Delete",
  messages: "Messages",
  confirm: "Confirm",
  noPostsPlaceHolder: "No Posts To View",
  confirmDeleteMessageModalText:
