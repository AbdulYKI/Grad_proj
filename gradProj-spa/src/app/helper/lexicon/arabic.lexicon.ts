...
export const arabicLexicon = {
  ...
  inbox: "الوارد",
  outbox: "الصادر",
  noMessagesPlaceHolder: "لا رسائل",
  messageColumnHeaderText: "الرسالة",
  toColumnHeaderText: "إلى",
  fromColumnHeaderText: "من",
  sentColumnHeaderText: "بُعثت",
  recievedColumnHeaderText: "أُستلمت",
  deleteButtonText: "مسح",
  messages: "الرسائل",
  confirm: "تأكيد",
  noPostsPlaceHolder: "لا يوجد منشورات",
