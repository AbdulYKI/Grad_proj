...
namespace grad_proj_api.Interfaces
{
    public interface IMainRepository
    {
        ...
        Task<PagedList<Message>> GetMessagesForUser(MessagePaginationParams messageParam, int userId);
        Task<PagedList<User>> GetUsersForList(ProfileListPaginationParams profileListPaginationParams);
    }
}